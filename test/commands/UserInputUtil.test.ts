...
describe('UserInputUtil', () => {
    ...
    describe('showEnvironmentQuickPickBox', () => {
        it('should show only remote environments', async () => {
            ...
            const result: IBlockchainQuickPickItem<FabricEnvironmentRegistryEntry> = await UserInputUtil.showFabricEnvironmentQuickPickBox('choose an environment', false) as IBlockchainQuickPickItem<FabricEnvironmentRegistryEntry>;
