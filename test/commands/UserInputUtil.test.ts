...
describe('UserInputUtil', () => {
    ...
    describe('showOpsToolNodesQuickPickBox', () => {
        let peerNode: FabricNode;
        let peerNode1: FabricNode;
        let peerNode2: FabricNode;
        let caNode: FabricNode;
        ...
        it('should throw an error if no nodes in Ops Tool', async () => {
            ...
            await UserInputUtil.showOpsToolNodesQuickPickBox('choose your nodes', nodes, true).should.eventually.be.rejectedWith('Error when importing nodes, no nodes found to choose from.') as IBlockchainQuickPickItem<FabricNode>[];
        });
        ...
        it('should allow the user to choose multiple nodes from Ops Tool', async () => {
            ...
            const result: IBlockchainQuickPickItem<FabricNode>[] = await UserInputUtil.showOpsToolNodesQuickPickBox('choose your nodes', nodes, true) as IBlockchainQuickPickItem<FabricNode>[];
