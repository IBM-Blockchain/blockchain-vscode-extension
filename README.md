...
**Please note:** If a smart contract was created before version 0.1.0 of this extension, the `package.json` file must contain a dependency on `fabric-contract@1.4.0-beta2`.
