...
<img src="https://github.com/niv23/blockchain-vscode-extension/blob/readme-updates/client/media/1_create_a_fabric_smart_contract_project.gif" width="85%" alt="Start a new Fabric smart contract project">
...
<img src="https://github.com/niv23/blockchain-vscode-extension/blob/readme-updates/client/media/2_edit:write_smart_contract_files.png" width="85%" alt="Edit smart contract files">
<!---Link to docs with further instructions
--->

### Package a smart contract project

<img src="https://github.com/niv23/blockchain-vscode-extension/blob/readme-updates/client/media/3_package_a_smart_contract_project.png" width="85%" alt="Create a package from a smart contract project">
...
<img src="https://github.com/niv23/blockchain-vscode-extension/blob/readme-updates/client/media/4_connect_to_a_local_fabric_runtime.gif" width="85%" alt="Connect to local_fabric runtime">
...
<img src="https://github.com/niv23/blockchain-vscode-extension/blob/readme-updates/client/media/5_connect_to_a_specified_fabric_runtime.png" width="85%" alt="Connect to the network and discover the existing resources">
<!---Link to docs with further instructions
--->
...
<img src="https://github.com/niv23/blockchain-vscode-extension/blob/readme-updates/client/media/6_install_smart_contract_package.png" width="85%" alt="Install new smart contract">
...
<img src="https://github.com/niv23/blockchain-vscode-extension/blob/readme-updates/client/media/7_instantiate_smart_contract_package.gif" width="85%" alt="Instantiate new smart contract">
