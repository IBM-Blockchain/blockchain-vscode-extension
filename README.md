...
<img src="https://github.com/niv23/blockchain-vscode-extension/blob/readme-updates/client/media/2_edit_write_smart_contract_files.png" width="85%" alt="Edit smart contract files">
<!---Link to docs with further instructions
--->
