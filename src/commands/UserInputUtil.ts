...
export class UserInputUtil {
    ...
    public static async showFabricEnvironmentQuickPickBox(prompt: string, canPickMany: boolean, showLocalFabric: boolean = false): Promise<Array<IBlockchainQuickPickItem<FabricEnvironmentRegistryEntry>> | IBlockchainQuickPickItem<FabricEnvironmentRegistryEntry> | undefined> {
        const quickPickOptions: vscode.QuickPickOptions = {
            ignoreFocusOut: true,
