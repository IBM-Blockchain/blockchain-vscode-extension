...
describe('IssuesList', () => {
    ...
    it('should show error test if error is passed as a prop', async () => {
        const component: ReactWrapper<{issues: any, error: any, title: any, issueLabel: any, newestMilestone: any, milestoneNumber: any}, {}, IssuesList> = await mount(<IssuesList error={'someError'}/>);
        component.text().includes('someError').should.be.true;
    });

    it('should show message if no incidents to show', async () => {
        const component: ReactWrapper<{issues: any, error: any, title: any, issueLabel: any, newestMilestone: any, milestoneNumber: any}, {}, IssuesList> = await mount(<IssuesList issues={[]}/>);
    ...
    it('should show message if no completed issues to show from the most recent milestone', async () => {
        const component: ReactWrapper<{issues: any, error: any, title: any, issueLabel: any, newestMilestone: any, milestoneNumber: any}, {}, IssuesList> = await mount(<IssuesList issues={[]} newestMilestone={'someMilestone'}/>);
    ...
    it('should show any incidents', async () => {
        ...
        const component: ReactWrapper<{issues: any, error: any, title: any, issueLabel: any, newestMilestone: any, milestoneNumber: any}, {}, IssuesList> = await mount(<IssuesList issues={incidents}/>);
    ...
    it('should show any completed issues for the next release', async () => {
        ...
        const component: ReactWrapper<{issues: any, error: any, title: any, issueLabel: any, newestMilestone: any, milestoneNumber: any}, {}, IssuesList> = await mount(<IssuesList issues={completedIssues} newestMilestone={'someMilestone'}/>);
