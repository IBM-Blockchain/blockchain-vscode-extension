...
import SampleTabs from '../../src/components/elements/SampleTabs/SampleTabs';
...
describe('SampleTabs component', () => {
    ...
    it('should render the expected snapshot', () => {
        const component: any = renderer
            .create(<SampleTabs repositoryData={repositories}/>)
            .toJSON();
        expect(component).toMatchSnapshot();
    });

    it('should render the expected snapshot when no sample data is received', () => {
        const component: any = renderer
            .create(<SampleTabs repositoryData={{repositories: []}}/>)
            .toJSON();
        expect(component).toMatchSnapshot();
