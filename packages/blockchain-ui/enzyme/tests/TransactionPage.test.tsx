...
describe('TransactionPage component', () => {
    ...
    it('should render the expected snapshot', async () => {
        const component: any = renderer
            .create(<TransactionPage gatewayName={'my gateway'} smartContract={greenContract} transactionOutput={mockTransactionOutput}/>)
            .toJSON();
    ...
    it('should update the transaction output when something new is passed down through props', async () => {
        ...
        const component: any = mount(<TransactionPage gatewayName={'my gateway'} smartContract={greenContract} transactionOutput={mockTransactionOutput}/>);
