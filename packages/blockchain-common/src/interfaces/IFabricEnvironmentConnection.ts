...
export interface IFabricEnvironmentConnection {
    ...
    instantiateChaincode(chaincodeName: string, version: string, peerNames: Array<string>, channelName: string, fcn: string, args: Array<string>, collectionConfigString: string, contractEP: any): Promise<void>;

    upgradeChaincode(chaincodeName: string, version: string, peerNames: Array<string>, channelName: string, fcn: string, args: Array<string>, collectionConfigString: string, contractEP: any): Promise<void>;
