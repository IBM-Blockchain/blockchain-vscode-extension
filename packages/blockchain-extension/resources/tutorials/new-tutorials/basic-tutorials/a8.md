...
> <br>
   > <b>Note:</b>  If you don't see the 'Run Test' and 'Debug Test' hyperlinks, you need to install the <a href="vscode:extension/oshri6688.javascript-test-runner">Node Test Runner Extension</a>.
   > <br>&nbsp;
<br>
...
Replace the *assert.strictEqual(true, true);* statement with the line:
```typescript
