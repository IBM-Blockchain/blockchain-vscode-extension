...
describe('AddEnvironmentCommand', () => {
    ...
    describe('addEnvironment', () => {
        ...
        it('should open tutorial if user wants to learn about creating additional networks', async () => {
            ...
            const executeCallsPreview: sinon.SinonSpyCall[] = executeCommandStub.getCalls().filter( (call: sinon.SinonSpyCall)  => call.args[0] === 'markdown.showPreview');
            executeCallsPreview.length.should.equal(1);
            executeCallsPreview[0].args[1].path.should.equal(tutorialPath);
