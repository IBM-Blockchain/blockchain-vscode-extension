...
describe('exportAppData', () => {
    ...
    beforeEach(async () => {
        ...
        gatewayRegistryEntry = new FabricGatewayRegistryEntry({
            ...
            connectionProfilePath: 'myPath/connection.json'
        });
        ...
        mySandBox.stub(FabricWallet.prototype, 'getIdentityNames').resolves(['someIdentity', 'someOtherIdentity', 'anotherRandomIdentity']);
