...
describe('manageFeatureFlags', () => {
    ...
    it('should handle the user cancelling', async () => {
        ...
        showQuickPickItemStub.should.have.been.calledOnceWithExactly('Enable or disable experimental features', [{
            data: FeatureFlagManager.EXPORTAPPDATA,
            label: FeatureFlagManager.EXPORTAPPDATA.getName(),
            description: FeatureFlagManager.EXPORTAPPDATA.getDescription(),
            picked: false
        }, {
            data: FAKE_FEATURE,
    ...
    it('should mark any enabled flags as picked', async () => {
        enabledStub.withArgs(FeatureFlagManager.EXPORTAPPDATA).resolves(true);
        await vscode.commands.executeCommand(ExtensionCommands.MANAGE_FEATURE_FLAGS);
        showQuickPickItemStub.should.have.been.calledOnceWithExactly('Enable or disable experimental features', [{
            data: FeatureFlagManager.EXPORTAPPDATA,
            label: FeatureFlagManager.EXPORTAPPDATA.getName(),
    ...
    it('should handle the user enabling a flag', async () => {
        ...
        await vscode.commands.executeCommand(ExtensionCommands.MANAGE_FEATURE_FLAGS);
        enableStub.should.have.been.calledOnceWithExactly(FeatureFlagManager.EXPORTAPPDATA);
    ...
    it('should handle the user disabling a flag', async () => {
        ...
        disableStub.should.have.been.calledWithExactly(FeatureFlagManager.EXPORTAPPDATA);
