...
${FabricRuntimeUtil.LOCAL_FABRIC} - Org1 Wallet`);
            ...
            it('should display ops tools gateway', async () => {
                ...
                const opsToolsGateway: FabricGatewayRegistryEntry = new FabricGatewayRegistryEntry({ name: 'someGateway', environmentGroup: 'opsToolsEnv', associatedWallet: 'Org1 Wallet', displayName: `Org1`, connectionProfilePath: 'some/file/path' });
            ...
            it('should display saas ops tools gateway', async () => {
                ...
                const saasGateway: FabricGatewayRegistryEntry = new FabricGatewayRegistryEntry({ name: 'someGateway', environmentGroup: 'saasEnv', associatedWallet: 'Org1 Wallet', displayName: `Org1`, connectionProfilePath: 'some/file/path' });
            ...
            it('should still display gateway if its environment has been deleted', async () => {
                ...
                const myCommand: vscode.Command = {
                    command: ExtensionCommands.CONNECT_TO_GATEWAY,
                    title: '',
                    arguments: [{ name: 'someGateway', associatedWallet: 'Org1 Wallet', displayName: `Org1`, connectionProfilePath: 'some/file/path' }]
                };
                ...
                groupGateways[0].label.should.equal(`Org1 ⧉`);
                groupGateways[0].collapsibleState.should.equal(vscode.TreeItemCollapsibleState.None);
                groupGateways[0].gateway.should.deep.equal({ name: 'someGateway', associatedWallet: 'Org1 Wallet', displayName: `Org1`, connectionProfilePath: 'some/file/path' });
                groupGateways[0].command.should.deep.equal(myCommand);
                groupGateways[0].tooltip.should.deep.equal(`ⓘ Associated wallet:\n    Org1 Wallet`);
            });
            ...
            it('should display multiple gateway groups', async () => {
                ...
                const gateway1: FabricGatewayRegistryEntry = new FabricGatewayRegistryEntry({ name: 'gateway1', environmentGroup: 'someEnvironment', associatedWallet: 'Org1 Wallet', displayName: 'Org1', connectionProfilePath: 'some/file/path'});
                const gateway2: FabricGatewayRegistryEntry = new FabricGatewayRegistryEntry({ name: 'gateway2', environmentGroup: 'someOtherEnvironment', associatedWallet: 'Org1 Wallet', displayName: 'Org1', connectionProfilePath: 'some/file/path'});
                const gateway3: FabricGatewayRegistryEntry = new FabricGatewayRegistryEntry({ name: 'gateway3', associatedWallet: 'Org1 Wallet', displayName: 'Org1', connectionProfilePath: 'some/file/path'});
