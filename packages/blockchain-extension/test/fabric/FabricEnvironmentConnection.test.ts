...
describe('FabricEnvironmentConnection', () => {
    ...
    describe('instantiateChaincode', () => {
        ...
        it('should instantiate the specified chaincode with a remote orderer', async () => {
            ...
            mockOrderer.getName.returns('orderer.example.com:7050');
            const payload: Buffer = await connection.instantiateChaincode('myChaincode', '0.0.1', ['peer0.org1.example.com', 'peer0.org2.example.com'], 'mychannel', 'instantiate', ['arg1'], [{ name: 'myCollection' }], undefined);
            ...
            sendInstantiateProposalStub.should.have.been.calledOnceWithExactly({
                ...
                'fcn': 'instantiate',
                'args': ['arg1'],
                'collections-config': [{ name: 'myCollection' }],
        ...
        it('should instantiate the specified chaincode and return the payload', async () => {
            ...
            const payload: Buffer = await connection.instantiateChaincode('myChaincode', '0.0.1', ['peer0.org1.example.com'], 'mychannel', 'instantiate', ['arg1'], [{ name: 'myCollection' }], undefined);
        ...
        it('should only instantiate with peers with the correct name and version installed', async () => {
            ...
            const payload: Buffer = await connection.instantiateChaincode('myChaincode', '0.0.1', ['peer0.org1.example.com', 'peer1.org1.example.com', 'peer2.org1.example.com'], 'mychannel', 'instantiate', ['arg1'], [{ name: 'myCollection' }], undefined);
            should.equal(payload, null);
        ...
        it('should throw an error if the specified chaincode is already instantiated', async () => {
            await connection.instantiateChaincode('otherChaincode', '0.0.1', ['peer0.org1.example.com'], 'mychannel', 'instantiate', ['arg1'], [{ name: 'myCollection' }], undefined)
        ...
        it('should throw an error if a peer returns an error as a proposal response', async () => {
            ...
            await connection.instantiateChaincode('myChaincode', '0.0.1', ['peer0.org1.example.com'], 'mychannel', 'instantiate', ['arg1'], [{ name: 'myCollection' }], undefined)
                .should.be.rejectedWith(/such error/);
        });
        ...
        it('should throw an error if the orderer in the channel configuration is not known and all the peers are not local', async () => {
            ...
            await connection.instantiateChaincode('myChaincode', '0.0.1', ['peer0.org1.example.com', 'peer0.org2.example.com'], 'mychannel', 'instantiate', ['arg1'], [{ name: 'myCollection' }], undefined)
    ...
    describe('upgradeChaincode', () => {
        ...
        it('should upgrade the specified chaincode with a remote orderer', async () => {
            ...
            mockPeer2.getUrl.returns('grpcs://peer0.org2.example.com:8051');
            mockOrderer.getName.returns('orderer.example.com:7050');
            const payload: Buffer = await connection.upgradeChaincode('myChaincode', '0.0.2', ['peer0.org1.example.com', 'peer0.org2.example.com'], 'mychannel', 'instantiate', ['arg1'], [{ name: 'myCollection' }], undefined);
            should.equal(payload, null);
        ...
        it('should upgrade the specified chaincode and return the payload', async () => {
            ...
            const payload: Buffer = await connection.upgradeChaincode('myChaincode', '0.0.2', ['peer0.org1.example.com'], 'mychannel', 'instantiate', ['arg1'], [{ name: 'myCollection' }], undefined);
            payload.toString().should.equal('hello world');
            sendUpgradeProposalStub.should.have.been.calledOnceWithExactly({
                'targets': [sinon.match.any],
                'chaincodeId': 'myChaincode',
        ...
        it('should upgrade the specified chaincode using peers with the correct name and version installed', async () => {
            ...
            const payload: Buffer = await connection.upgradeChaincode('myChaincode', '0.0.2', ['peer0.org1.example.com', 'peer1.org1.example.com', 'peer2.org1.example.com'], 'mychannel', 'instantiate', ['arg1'], [{ name: 'myCollection' }], undefined);
            should.equal(payload, null);
        ...
        it('should throw an error if the specified chaincode is not already instantiated', async () => {
            await connection.upgradeChaincode('noSuchChaincode', '0.0.1', ['peer0.org1.example.com'], 'mychannel', 'instantiate', ['arg1'], [{ name: 'myCollection' }], undefined)
        ...
        it('should throw an error if the specified chaincode is already instantiated with the same version', async () => {
            await connection.upgradeChaincode('myChaincode', '0.0.1', ['peer0.org1.example.com'], 'mychannel', 'instantiate', ['arg1'], [{ name: 'myCollection' }], undefined)
        ...
        it('should throw an error if a peer returns an error as a proposal response', async () => {
            ...
            await connection.upgradeChaincode('myChaincode', '0.0.2', ['peer0.org1.example.com'], 'mychannel', 'instantiate', ['arg1'], [{ name: 'myCollection' }], undefined)
                .should.be.rejectedWith(/such error/);
        });
        ...
        it('should throw an error if the orderer in the channel configuration is not known and all the peers are not local', async () => {
            ...
            mockPeer2.getUrl.returns('grpcs://peer0.org2.example.com:8051');
            loadConfigEnvelopeStub.returns({ orderers: ['nosuchorderer.example.com'] });
            await connection.upgradeChaincode('myChaincode', '0.0.2', ['peer0.org1.example.com', 'peer0.org2.example.com'], 'mychannel', 'instantiate', ['arg1'], [{ name: 'myCollection' }], undefined)
                .should.be.rejectedWith(/Failed to find Fabric orderer\(s\) nosuchorderer.example.com for channel mychannel/);
        });
