Feature: Fabric Environments
    ...
    #     Then there shouldn't be a Node tree item with a label 'Org1CA' in the 'Fabric Environments' panel
    #     And there should be a Node tree item with a label 'Org1Peer1' in the 'Fabric Environments' panel
