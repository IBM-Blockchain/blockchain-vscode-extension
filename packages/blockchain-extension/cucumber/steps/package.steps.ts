...
module.exports = function(): any {
    ...
    this.Given('the contract has been packaged', this.timeout, async () => {
        this.packageRegistryEntry = await this.smartContractHelper.packageSmartContract(this.contractDefinitionName, this.contractDefinitionVersion, this.contractLanguage, this.contractDirectory);
    });
