...
export class ExtensionUtil {
    ...
    */
    public static async registerCommands(context: vscode.ExtensionContext): Promise<vscode.ExtensionContext> {
        ...
        context.subscriptions.push(vscode.commands.registerCommand(ExtensionCommands.IMPORT_NODES_TO_ENVIRONMENT, (environmentRegistryEntry: FabricEnvironmentRegistryEntry, fromAddEnvironment: boolean = false, createMethod: string = UserInputUtil.ADD_ENVIRONMENT_FROM_NODES) => importNodesToEnvironment(environmentRegistryEntry, fromAddEnvironment, createMethod)));
        context.subscriptions.push(vscode.commands.registerCommand(ExtensionCommands.EDIT_NODE_FILTERS, (environmentRegistryEntry: FabricEnvironmentRegistryEntry, fromAddEnvironment: boolean = false, createMethod: string = UserInputUtil.ADD_ENVIRONMENT_FROM_OPS_TOOLS) => importNodesToEnvironment(environmentRegistryEntry, fromAddEnvironment, createMethod)));
        ...
        context.subscriptions.push(vscode.commands.registerCommand(ExtensionCommands.HIDE_NODE, (nodeTreeItem: NodeTreeItem, hideNode: boolean = true) => deleteNode(nodeTreeItem, hideNode)));
