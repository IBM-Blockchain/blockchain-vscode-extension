...
export class ExtensionUtil {
    ...
    */
    public static async registerCommands(context: vscode.ExtensionContext): Promise<vscode.ExtensionContext> {
        ...
        context.subscriptions.push(vscode.commands.registerCommand(ExtensionCommands.UPGRADE_SMART_CONTRACT, (channelName: string, peerNames: Array<string>, selectedPackage: PackageRegistryEntry, instantiateFunctionName: string, instantiateFunctionArgs: string[], endorsementPolicy: any, collectionConfigString: string) => upgradeSmartContract(channelName, peerNames, selectedPackage, instantiateFunctionName, instantiateFunctionArgs, endorsementPolicy, collectionConfigString)));
